...
For this part of the assignment, ignore all missing values and 
...
For this part of the assignment, ignore all missing values and 
first first calculate the total number of steps taken per interval, averaged across all days.
